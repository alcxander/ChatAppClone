...
export const toggle = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    // so here we have a query to get a value from the db in convex without using a predefined filter.
    // this is much closer to what i have seen elsewhere before in other database languages
